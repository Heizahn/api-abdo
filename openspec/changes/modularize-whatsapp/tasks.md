...
- [ ] 2.4 Move settings + WhatsApp Numbers + test-connection into `settings/{mod.rs,handlers.rs,validation.rs}`. _(PR4a extracted validation helpers only; settings/test-connection handlers remain in `handler.rs`.)_
