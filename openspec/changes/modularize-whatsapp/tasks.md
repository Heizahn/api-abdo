...
- [ ] 2.3 Move messaging/media/reaction code into `messaging/{mod.rs,send.rs,reactions.rs,media.rs,preview.rs}`. _(PR3a — preview helpers only; remainder intentionally not moved in this safe pre-step.)_
