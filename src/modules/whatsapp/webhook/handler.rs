...
/// `receive_webhook` remains in the legacy `handler.rs` module for now.
/// The module boundary is already established; ownership of this function
/// migrates in a follow-up slice.
pub use crate::modules::whatsapp::handler::receive_webhook;
