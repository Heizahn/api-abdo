...
use crate::{
    ...
    error::ApiError,
    models::whatsapp::{
        HeaderMediaUploadData, HeaderMediaUploadResponse, MediaLimitsResponse, MediaTypeLimit,
        MediaUploadData, MediaUploadResponse,
    },
    modules::whatsapp::{
...
pub(crate) async fn swap_header_handles_in_components(
    state: &Arc<AppState>,
