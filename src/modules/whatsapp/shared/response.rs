...
pub(crate) fn settings_to_item(s: WaSettings) -> SettingsItem {
    SettingsItem {
        ...
        audio_transcription_enabled: s.audio_transcription_enabled,
        stt_model: s.stt_model,
        stt_language: s.stt_language,
        show_audio_transcription: s.show_audio_transcription,
        ai_uses_audio_transcription: s.ai_uses_audio_transcription,
        max_audio_transcription_seconds: s.max_audio_transcription_seconds,
