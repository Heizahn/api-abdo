...
use crate::models::whatsapp::{
    ...
    LocationPayload, MarkReadResponse, MediaLimitsResponse, MediaSendPayload, MediaTypeLimit,
    MediaUploadResponse, MessageItem, QuickRepliesListResponse, QuickReplyButton,
...
#[openapi(
    ...
    components(
        schemas(
            ...
            SendMessageResponse,
            MediaUploadResponse, MediaLimitsResponse, MediaTypeLimit,
            MarkReadResponse,
