...
use crate::models::ai_agent::{
    ...
    AiAgentRuntimeContractDto, AiAgentTransferTargetRef, AiAgentsExportPackageData,
    AiAgentsExportPackageResponse, AiAgentsImportPackageData, AiAgentsImportPackageRequest,
    AiAgentsImportPackageResponse, AiAgentsListResponse, AiBusinessDataDeleteResponse, AiConfigDto,
...
#[openapi(
    ...
    components(
        schemas(
            ...
            AiAgentItem, AiAgentRuntimeContractDto,
